/* This file is based off upstream release 0.42.2, autogenerated on x86_64 Linux
 * and adapted to work with Unikraft.
 * Options marked with UNIKRAFT have been changed from autoconfigured values */
...
/* UNIKRAFT */
#if CONFIG_LIBINTEL_INTRINSICS && defined(__SSE2__)
#define USE_SSE2 1
#endif

/* use SSSE3 compiler intrinsics */
/* UNIKRAFT */
#if CONFIG_LIBINTEL_INTRINSICS && defined(__SSSE3__)
#define USE_SSSE3 1
#endif
...
/* UNIKRAFT */
#if CONFIG_LIBINTEL_INTRINSICS && defined(__MMX__)
